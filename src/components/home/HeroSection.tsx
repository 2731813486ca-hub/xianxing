    ...
    >
      ...
      <div className={`pointer-events-none absolute inset-0${entrance ? " hero-decorative" : ""}`}>
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(rgba(215,170,69,0.07) 1px, transparent 1px), linear-gradient(90deg, rgba(215,170,69,0.07) 1px, transparent 1px)",
        ...
        {/* Bottom radial glow — warm gold light fading into content */}
        <div
